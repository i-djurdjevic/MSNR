...
\begin{itemize}
	\item \textit{Prirodna semantika} (ili veliki koraci (eng. big-step semantics)): svrha joj je da opiše kako su \textit{ukupni rezultati} izvršavanja dobijeni.
...
Opišimo sada značenje za obe vrste operacione semantike, prirodne i strukturno operacione, \textit{tranzicionim sistemom} na primeru rada \emph{While} petlje. Ona će imati dve vrste konfiguracija \cite{willey}:
\begin{itemize}
